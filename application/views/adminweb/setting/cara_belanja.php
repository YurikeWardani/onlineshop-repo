  ...
  <div class="card border-0 shadow-lg p-3 mb-5 bg-white rounded ">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs" role="tablist">
        <li class="nav-item"><a class="nav-link active" href="#result4" data-bs-toggle="tab" role="tab" aria-controls="result4" aria-selected="true">Setting Cara Belanja</a></li>
      </ul>
    </div>
    <div class="card-body">
      <div class="tab-content">
        <div class="tab-pane fade show active" id="result4" role="tabpanel">
          ...
          if ($this->session->flashdata('message')){
            ...
            Konten <b>Cara Belanja</b> berhasil diubah!</div>";
          }
          else if (($this->session->flashdata('error'))) {
            echo "<div class='alert alert-error' role='alert' style='font-size: 12px'>
            Konten <b>Cara Belanja</b> gagal diubah!</div>";
          }

          ?>
          <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="<?php echo base_url();?>adminweb/carabelanja_simpan">
            <input type="hidden" name="id_carabelanja" id="id_tentangkami" class="form-control" required="required" value="<?php echo $id_carabelanja;?>">
            ...
            <div class="form-group col-md-1" style="margin-bottom: 20px;">
              ...
              <textarea name="deskripsi" id="deskripsi" required="required" class="form-control" rows="8" ><?php echo $deskripsi;?></textarea>
            </div>                        
