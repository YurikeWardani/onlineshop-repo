...
<section class="col-lg-12">
  <div class="border-bottom mt-lg-2 pt-5 pb-2 mb-5">
    ...
    <div class="d-flex flex-wrap flex-md-nowrap justify-content-between">
      <p class="text-muted">Data Belum Diproses </p> 
    </div>
  </div>
  <?php 
        ...
        if ($data_transaksi->num_rows()>0) {
          foreach ($data_transaksi->result_array() as $tampil) { ?>
            <tr >
              ...
              <td class="py-3">
                <a href="<?php echo base_url();?>adminweb/transaksi_proses/<?php echo $tampil['id_transaksi_header'];?>" class="btn btn1 btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Proses</a>
                <a href="<?php echo base_url();?>adminweb/transaksi_detail/<?php echo $tampil['id_transaksi_header'];?>/<?php echo $tampil['kode_transaksi'];?>" class="btn btn1 btn-info"><i class="fa fa-search" aria-hidden="true"></i> Detail</a>
              </td>
            </tr>
            <?php
            $no++;
