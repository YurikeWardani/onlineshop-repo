...
<head>
  ...
  <link rel="stylesheet" media="screen" href="<?php echo base_url('assets1'); ?>/vendor/prismjs/themes/prism.css"/>
  <link rel="stylesheet" media="screen" href="<?php echo base_url('assets1'); ?>/vendor/prismjs/plugins/toolbar/prism-toolbar.css"/>
  <link rel="stylesheet" media="screen" href="<?php echo base_url('assets1'); ?>/vendor/prismjs/plugins/line-numbers/prism-line-numbers.css"/>
  ...
  <main class="container-fluid">
    ...
    <section class="offcanvas-enabled row pb-3 pb-md-4">
      <div class="col-xxl-12">
        <!-- Navbar-->
        <header class="navbar navbar-expand navbar-light fixed-top bg-light shadow-sm px-3 px-lg-4" data-scroll-header data-fixed-element><a class="navbar-brand d-lg-none" href="typography.html"><img src="<?php echo base_url('assets1'); ?>/img/logo-dark.png" width="142" alt="Cartzilla"></a>
          <ul class="navbar-nav ms-auto d-none d-lg-flex">
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('assets1'); ?>/index.html"><i class="ci-eye align-middle mt-n1 me-2"></i>Live preview</a></li>
            <li class="nav-item">
              <div class="nav-link disabled text-border px-1">|</div>
            </li>
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('assets1'); ?>/docs/dev-setup.html"><i class="ci-book align-middle mt-n1 me-2"></i>Documentation</a></li>
            <li class="nav-item">
              <div class="nav-link disabled text-border px-1">|</div>
            </li>
          </ul>
        ...
        <aside class="offcanvas offcanvas-expand bg-dark" id="components-nav">
          <div class="offcanvas-header bg-darker d-none d-lg-block"><a class="navbar-brand py-1" href="typography.html"><img src="<?php echo base_url('assets1'); ?>/img/logo-light.png" width="142" alt="Cartzilla"></a><span class="badge bg-info">Components</span></div>
          ...
          <div class="offcanvas-body py-0" data-simplebar data-simplebar-auto-hide="true">
            <div class="pt-4 pb-3 mt-lg-3">
              <div class="d-flex d-lg-none pb-4 mb-4 border-bottom border-light"><a class="btn btn-outline-light btn-sm me-3" href="<?php echo base_url('assets1'); ?>/index.html"><i class="ci-eye align-middle mt-n1 me-2"></i>Live demo</a><a class="btn btn-light btn-sm ps-2" href="<?php echo base_url('assets1'); ?>/docs/dev-setup.html"><i class="ci-book align-middle mt-n1 me-2"></i>Documentation</a></div>
              <div class="widget widget-links widget-light border-bottom border-light mb-4 ">
                <h3 class="widget-title text-white"><a href="">Dashboard</a></h3>
              </div>
              <div class="widget widget-links widget-light border-bottom border-light mb-4 pb-4 me-n3">
                ...
                <ul class="widget-list">
                  ...
                  <li class="widget-list-item"><a class="widget-list-link" href="icon-font.html">Transaksi Sudah Diproses</a></li>
                </ul>
              </div>
              <div class="widget widget-links widget-light border-bottom border-light mb-4 pb-4 me-n3">
                <h3 class="widget-title text-white">Produk</h3>
                <ul class="widget-list">
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Brand</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="icon-font.html"> Kategori</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="code.html"> Produk</a></li>
                </ul>
              </div>
              <div class="widget widget-links widget-light border-bottom border-light mb-4 pb-4 me-n3">
                <h3 class="widget-title text-white">Setting</h3>
                <ul class="widget-list">
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Tentang Kami</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Cara Belanja</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Slider</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Kontak</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Logo</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Sosial Media</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="<?php echo base_url('adminweb/seo')?>"> SEO</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Kota</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Bank</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Jasa Pengiriman</a></li>
                  <li class="widget-list-item"><a class="widget-list-link" href="typography.html"> Admin</a></li>
                </ul>
              </div>
            </div>
          </aside>
          <div class="border-bottom mt-lg-2 pt-5 pb-2 mb-5">
            <h1 class="mt-3 mt-lg-4 pt-5">Typography</h1>
            <div class="d-flex flex-wrap flex-md-nowrap justify-content-between">
              <p class="text-muted">Headings, body text, lists, and more.</p>
              <p class="fs-sm ps-md-4"><a class="text-nowrap" href="https://getbootstrap.com/docs/5.1/content/typography/" target="_blank" rel="noopener">Bootstrap docs<i class="ci-arrow-right align-middle ms-1"></i></a></p>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="result1" role="tabpanel">
                    ...
                    <hr>
                    <h2 class="pt-3">h2. Cartzilla heading</h2>
                    <hr>
                    <h3 class="pt-3">h3. Cartzilla heading</h3>
                    <hr>
                    <h4 class="pt-3">h4. Cartzilla heading</h4>
                    <hr>
                    <h5 class="pt-3">h5. Cartzilla heading</h5>
                    <hr>
                    <h6 class="pt-3">h6. Cartzilla heading</h6>
                  </div>
                  ...
                  <div class="tab-pane fade" id="pug1" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Headings
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug2" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Display headings
          ...
          <section class="pb-5 mb-md-2" id="type-body-text">
            <h2 class="h5 mb-3">Body text sizes</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="result3" role="tabpanel">
                    ...
                    <p class="fs-md"><strong>Medium.&nbsp;</strong>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor</p>
                    <p class="fs-sm"><strong>Small.&nbsp;</strong>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor</p>
                    <p class="fs-ms"><strong>Medium small.&nbsp;</strong>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor</p>
                  ...
                  <div class="tab-pane fade" id="html3" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-html">&lt;!-- Body text sizes --&gt;
                      ...
                      &lt;p class=&quot;fs-md&quot;&gt;Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor&lt;/p&gt;
                      &lt;p class=&quot;fs-sm&quot;&gt;Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor&lt;/p&gt;
                      &lt;p class=&quot;fs-ms&quot;&gt;Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor&lt;/p&gt;
                  ...
                  <div class="tab-pane fade" id="pug3" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Body text sizes
          ...
          <section class="pb-5 mb-md-2" id="type-inline">
            <h2 class="h5 mb-3">Inline text elements</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug4" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Inline text elements
          ...
          <section class="pb-5 mb-md-2" id="type-abbreviations">
            <h2 class="h5 mb-3">Abbreviations</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug5" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Abbreviations
                      p
          ...
          <section class="pb-5 mb-md-2" id="type-blockquote">
            <h2 class="h5 mb-3">Blockquote</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug6" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Blockquote
          ...
          <section class="pb-5 mb-md-2" id="type-lists">
            <h2 class="h5 mb-3">Lists: Unordered and ordered</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug7" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Unordered list
                      ul.list-style
          ...
          <section class="pb-5 mb-md-2" id="type-lists-unstyled">
            <h2 class="h5 mb-3">Lists: Unstyled</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug8" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Unstyled list
                      ul.list-unstyled
                      li Lorem ipsum dolor sit amet
                      li Consectetur adipiscing elit
                      li Integer molestie lorem at massa
          ...
          <section class="pb-5 mb-md-2" id="type-lists-inline">
            <h2 class="h5 mb-3">Lists: Inline</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug9" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Inline list
                      ul.list-inline
          ...
          <section class="pb-5 mb-md-2" id="type-description-list">
            <h2 class="h5 mb-3">Description list basic example</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug10" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Description list basic example
                      dl
          ...
          <section class="pb-5 mb-md-2" id="type-description-list-align">
            <h2 class="h5 mb-3">Description list alignment</h2>
            <div class="card border-0 shadow-lg">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#pug11" data-bs-toggle="tab" role="tab" aria-controls="pug11" aria-selected="false">Pug</a></li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="pug11" role="tabpanel">
                    <pre class="line-numbers"><code class="lang-pug">// Description list alignment
                      dl.row.mb-0
          ...
          <aside class="sticky-top pt-5">
            <div class="pt-5 mt-5">
              <div class="widget widget-links ps-4 border-start">
                ...
                <ul class="widget-list">
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-headings">Headings</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-displays">Display headings</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-body-text">Body text sizes</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-inline">Inline text elements</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-abbreviations">Abbreviations</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-blockquote">Blockquote</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-lists">Lists: Unordered and ordered</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-lists-unstyled">Lists: Unstyled</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-lists-inline">Lists: Inline</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-description-list">Description list basic example</a>
                  </li>
                  <li class="widget-list-item"><a class="widget-list-link" data-scroll href="#type-description-list-align">Description list alignment</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/components/prism-core.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/components/prism-markup.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/components/prism-clike.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/components/prism-javascript.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/components/prism-pug.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/plugins/toolbar/prism-toolbar.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/plugins/copy-to-clipboard/prism-copy-to-clipboard.min.js"></script>
    <script src="<?php echo base_url('assets1'); ?>/vendor/prismjs/plugins/line-numbers/prism-line-numbers.min.js"></script>
    <!-- Main theme script-->
